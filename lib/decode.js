...
function decodeImage(img) {
    fs.createReadStream(img)
        ...
        .on('parsed', function () {
            ...
            [stringLength, widthStep, heightStep] = conv.metaToObj(conv.bitsToString(stegotext));
            ...
            console.log(`${img} was decoded, message=${data.join('')}, pattern=${widthStep}x${heightStep}`);
            process.exit(0)
        })
}
